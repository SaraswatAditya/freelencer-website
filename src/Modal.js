...
const Modal = ({title,imagePath,target}) => (
    <div className="portfolio-modal modal fade" id={target} tabIndex="-1" aria-labelledby={target} aria-hidden="true">
                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-8">
                                    ...
                                    <img className="img-fluid rounded mb-5" src={imagePath} alt="..." />
